...
-- Danh Gia Bidder
-- ----------------------------
DROP TABLE IF EXISTS `bidder_rate`;
CREATE TABLE `bidder_rate` (
  `Bidder` char(50) COLLATE utf8_general_ci NOT NULL,
  `Seller` char(50) COLLATE utf8_general_ci NOT NULL,
  `Comment` text COLLATE utf8_general_ci, 
  `Rate` tinyint NOT NULL, 
  PRIMARY KEY (`Bidder`,`Seller`),
  FOREIGN KEY (`Bidder`) REFERENCES user(`Email`),
  FOREIGN KEY (`Seller`) REFERENCES user(`Email`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
-- ----------------------------
BEGIN;
INSERT INTO `user` VALUES ('huyanhngo@gmail.com','admin1','admin1','Ngô Huy Anh','153 Nguyễn Chí Thanh, Phường 9, Quận 5, TP.HCM','2001-01-01','2021-12-07','0',0);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `user` VALUES ('springfieldcaptain@gmail.com','bidder1','bidder1','Ngô Minh Triết','156 Nguyễn Chí Thanh, Phường 9, Quận 5, TP.HCM','1990-01-01','2021-12-07','2',0);
INSERT INTO `user` VALUES ('xyz@gmail.com','bidder2','bidder2','Ngô Ngọc Đăng Khôi','157 Nguyễn Chí Thanh, Phường 9, Quận 5, TP.HCM','1990-03-01','2021-12-07','2',0);
INSERT INTO `user` VALUES ('a@gmail.com','bidder3','bidder3','Ngô Ngọc Đăng Minh','158 Nguyễn Chí Thanh, Phường 9, Quận 5, TP.HCM','1990-04-01','2021-12-07','2',0);
INSERT INTO `user` VALUES ('b@gmail.com','bidder4','bidder4','Ngô Ngọc Đăng Khánh','159 Nguyễn Chí Thanh, Phường 9, Quận 5, TP.HCM','1990-05-01','2021-12-07','2',0);
INSERT INTO `user` VALUES ('c@gmail.com','bidder5','bidder5','Ngô Ngọc Đăng Huy','160 Nguyễn Chí Thanh, Phường 9, Quận 5, TP.HCM','1990-06-01','2021-12-07','2',0);
COMMIT;
